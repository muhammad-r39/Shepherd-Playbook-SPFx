...
const MedicarePage: React.FC<MedicarePageProps> = ({ spHttpClient }) => {
  React.useEffect(() => {
    const handleLoad = () => {
      ...
      <section className="hero-area">
        <div className="hero-banner">
          <img
            ...
            src={require("../../assets/img/banner/medicare.jpg")}
            alt="background image"
          />
          <div className="container">
            <h1 className="page-title">MEDICARE</h1>
          </div>
        </div>
          ...
          <div className="content-wrapper">
            <main>
              ...
              <section className="document-center">
                <h2>Medicare Document Center</h2>
                <h3>Top Resources</h3>
